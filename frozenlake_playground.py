...
from frozenlake import FrozenLakeAgent
import gym

ENV_MAP = 'FrozenLake-v0'
# ENV_MAP = 'FrozenLake8x8-v0'

for m in list(range(-6, -15, -1)) + [-20, -40]:
    agent = FrozenLakeAgent(big_map=(True if ENV_MAP == 'FrozenLake8x8-v0' else False),
                            max_length=m)
    pi = agent.get_policy()
    ...
    print("m={} -- success: {} / fail: {} / timeout: {}".format(m, success, fail, timeout))
